...
91 :      ゲームサーバーがアカウントサーバーにログインするときに使う。
92 :      接続を張ったあと、このログインをしないとすべてのサービスをしない。
93 :      <br><br>
94 :      <dl>
95 :        <dt>string servername
96 :        <dd>サーバー名。acserv.cfに設定されている。
97 :        <dt>string serverpas
98 :        <dd>サーバーパスワード。acserv.cfに設定されている。
99 :      </dl>
100 :   
*/
...
115 :      サーバーがアカウントサーバーからログアウトするときに使う。
116 :      接続はサーバによって勝手に切られる。したがってこれに対するアカウントサーバ
117 :      の返答はコネクションを切る事である。
118 :      <br>
119 :      <br>
120 :      <br>
121 : 
...
609 : 	 ゲームサーバーに対してこのコマンドを送信すると、
610 : 	 すべてのゲームサーバーにたいして同じメッセージが送信される。
611 : 	 id , charname はよくつかわれるので、個別の引数をもつようにした。
612 : 	 いちいち文字列パースのルーチンを書かなくてもいいように。
613 : 	 <dl>
614 : 	   <dt>string id
615 : 	   <dd>user ID
...
619 : 	   <dd>放送されるメッセージ。ゲームサーバーが好きに使う。
620 : 	 </dl>
*/
...
646 : 	   <dd>メッセージ本体
647 : 	   <dt>int option
648 : 	   <dd>オプション。チャットの色とかいろいろ入れれる。今後の拡張用
649 : 		   これをどう使うかはゲームサーバーの勝手で、アカウントサーバーは
650 : 		   一切この内容にタッチしない
651 : 	 </dL>
*/
...
355 : 	 上のコマンドの結果。失敗しても回復不可能なので無視してよいぞ
356 : 	 <dl>
357 : 	   <dt>string result
358 : 	   <dD>successful かfailed	   
359 : 	   <dt>string table
360 : 	   <dD>
361 : 	   <dt>int msgid
362 : 	   <dD>
...
479 : 	   <dd>順位。1以上の値を取る。
480 : 	   <dt>int count
481 : 	   <dd>上からいくつめか。最初のエントリは0からはじまる。
482 : 	   <dt>string table
483 : 	   <dd>テーブル名をそのままかえす
484 : 	   <dt>string key
485 : 	   <dd>キーをそのままかえす
486 : 	   <dt>int msgid, int msgid2
487 : 	   <dd>msgid をそのまま返す
488 : 	 </dl>
489 : 	 <BR><BR>
490 : 
491 : 	 
...
509 : 	   <dt>string table
510 : 	   <dd>テーブル名をそのままかえす
511 : 	   <dt>string key
512 : 	   <dd>キーをそのままかえす
513 : 	   <dt>int msgid, int msgid2
514 : 	   <dd>msgid をそのまま返す
515 : 	 </dl>
516 : 	 <BR><BR>
517 : 
*/
...
536 : 	   <dd>値そのもの
537 : 	   <dt>string table
538 : 	   <dd>テーブル名をそのままかえす
539 : 	   <dt>string key
540 : 	   <dd>キーをそのままかえす
541 : 	   <dt>int msgid, int msgid2
542 : 	   <dd>msgid をそのまま返す
543 : 	 </dl>
544 : 
545 : 
546 : 
...
594 : 	 DBGetEntryByCount の結果。
595 : 	 <dl>
596 : 	   <dt>string result
597 : 	   <dd>SUCCESSFUL/FAILED
598 : 	   <dt>string list
599 : 	   <dd>出力リスト。1エントリあたり "INDEX,RANK,KEY,SCORE,INFO" の4個の情報
600 : 		   の組であり、それが個数分 "|" でつながる。個数が0の場合は
601 : 		   空文字列。
602 : 	   <dt>int num
603 : 	   <dd>いくつとりだすか。1なら1個。2なら2個。
...
622 : 	 Broadcastのアカウントサーバーからゲームサーバーへの送信用
623 : 	 <dl>
624 : 	   <dt>string id
625 : 	   <dd>user ID
...
664 : 	   <dd>メッセージの本体
665 : 	   <dt>int option
666 : 	   <dd>オプション(上の関数を参照)
667 : 	   <dt>int mesgid
668 : 	   <dd>メッセージID アカウントサーバーの管理用
669 : 	 </dl>
670 : 
*/
