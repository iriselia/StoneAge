...
enum {
	CHAR_WORK_ENCOUNTTYPE	= CHAR_NPCWORKINT1,	/* エンカウントの仕方 */
	CHAR_WORK_DIEACT		= CHAR_NPCWORKINT2,	/* 死んだ時どうするか */
	CHAR_WORK_WARP_FLOOR	= CHAR_NPCWORKINT3,	/* ワープするフロア*/
	CHAR_WORK_WARP_X		= CHAR_NPCWORKINT4,	/* ワープするX */
	CHAR_WORK_WARP_Y		= CHAR_NPCWORKINT5,	/* ワープするY */
	CHAR_WORK_ONEBATTLE 	= CHAR_NPCWORKINT6,	/* 一つしか戦闘しない */
	NPC_TIME_MODE			= CHAR_NPCWORKINT7, 
	CHAR_WORK_BASEIMGBAK	= CHAR_NPCWORKINT8, /* もとの画像番号 */
	CHAR_WORK_DIETIME		= CHAR_NPCWORKINT9, /* 死んだ時間 */
	CHAR_WORK_REVIVALTIME	= CHAR_NPCWORKINT10, /* 生き返る時間 */
