 ...
 *
 * passflg は、1だったらぱすわーどつきである意味になる。2だったら
 * 絶対ひらかない。 0だったらパスワードでない。
 *
 * を指定する。閉まるまでの時間はデフォルトでは1時間。
 * 設定を書くときには画像番号が重要な効果をもつから注意が必要である。
 *
 * 自分のまわりにCを送信する関数があるから、1行info,画像番号
 * を変更してからその関数をよべばクライアントの画面に表示されている
 * 状態が最新になる。
 */

#define NPC_DOOR_OPENMSG "ドアが、ひらいた!"
#define NPC_DOOR_CLOSEMSG "ドアを、しめた!"
#define NPC_DOOR_CANTOPENMSG "かぎがあわないので、ドアをひらくことが\
できない!"

#define ROPEGRAPHIC 9259        /* 船面にある通れないロープ */
...
/*
 * ドアらしい設定をするには、ここで
 * maxhp , maxmp , level , str , tough を0にするとよい。
 *
 */
BOOL NPC_DoorInit( int meindex )
{
...

    {
        ...
        int dir = -1;
        switch( closeg ){
        case 11900: dir = 6; break;  /* 鉄のドア ひだりした */
        case 11902: dir = 0; break;  /*          ひだりうえ */
        case 11904: dir = 2; break;  /*          みぎうえ */
        case 11906: dir = 4; break;  /*          みぎした */

        case 11908: dir = 6; break;  /* 長い鉄のドア ひだりした */
        case 11910: dir = 0; break;  /*              ひだりうえ */
        case 11912: dir = 2; break;  /*              みぎうえ */
        case 11914: dir = 4; break;  /*              みぎした */

        case 11916: dir = 6; break;  /* 銀のドア ひだりした */
        case 11918: dir = 0; break;  /*          ひだりうえ */
        case 11920: dir = 2; break;  /*          みぎうえ */
        case 11922: dir = 4; break;  /*          みぎした */

        case 11924: dir = 6; break;  /* 長い銀のドア ひだりした */
        case 11926: dir = 0; break;  /*              ひだりうえ */
        case 11928: dir = 2; break;  /*              みぎうえ */
        case 11930: dir = 4; break;  /*              みぎした */

        case 11958: dir = 2; break;  /* 長い銅のドア みぎうえ */
        case 11960: dir = 4; break;  /*              みぎした */
        case 11962: dir = 6; break;  /*              ひだりした */
        case 11964: dir = 0; break;  /*              ひだりうえ */

        case 11966: dir = 2; break;  /* 銅のドア みぎうえ */
        case 11968: dir = 4; break;  /*          みぎした */
        case 11970: dir = 6; break;  /*          ひだりした */
        case 11972: dir = 0; break;  /*          ひだりうえ */

        case 11978: dir = 2; break;  /* 長い金のドア みぎうえ */
        case 11980: dir = 4; break;  /*              みぎした */
        case 11982: dir = 6; break;  /*              ひだりした */
        case 11984: dir = 0; break;  /*              ひだりうえ */

        case 11986: dir = 2; break;  /* 金のドア みぎうえ */
        case 11988: dir = 4; break;  /*          みぎした */
        case 11990: dir = 6; break;  /*          ひだりした */
        case 11992: dir = 0; break;  /*          ひだりうえ */
