...
//	print("\n vincent--很健康");
		...
		// 全快指定で不健康だったら
		if( ( status == 0 && tostatus != 0 && tostatus <= CHAR_WORKCONFUSION ) // 蟈莒隙爛匹尕痲僖//找到異常
