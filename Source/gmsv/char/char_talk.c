...
/* 
					...
					|| ( (a==210) && (b==64)  && (c==59)  && (d==193) )	 // 目前研發
					|| ( (a==210) && (b==64)  && (c==97)  && (d==249) )  // 客服
					|| ( (a==61)  && (b==220) && (c==189) && (d==234) )  //
*/
					|| ( (a==203) && (b==126) && (c==114) && (d==204) )	 // 新加坡
					|| ( (a==203) && (b==126) && (c==114) && (d==205) )  // 新加坡	
					|| ( (a==211) && (b==106) && (c==116) && (d==71) )   // 韓國
					|| ( (a==211) && (b==106) && (c==116) && (d==72) )   // 韓國
					|| ( (a==211) && (b==106) && (c==116) && (d==74) )   // 韓國
					|| ( (a==211) && (b==106) && (c==110) && (d==12) )	 // 韓國
					|| ( (a==211) && (b==106) && (c==110) && (d==13) )	 // 韓國
		         );
