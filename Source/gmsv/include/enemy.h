...
typedef enum
{
    ...
    E_T_FIREAT,
    E_T_WINDAT,
    E_T_POISON,               /* 毒歩くたびにダメージ          */
    E_T_PARALYSIS,            /* しびれ、1部の行動ができない。 */
    E_T_SLEEP,                /* 眠り。行動できない            */
    E_T_STONE,                /* 石。行動できない              */
    E_T_DRUNK,                /* 酔う。命中率が下がる     */
    E_T_CONFUSION,            /* 混乱。攻撃目標を誤る     */
    E_T_PETSKILL1,
    E_T_PETSKILL2,
    E_T_PETSKILL3,
    E_T_PETSKILL4,
...
{
    GROUP_ID,
	GROUP_APPEARBYITEMID,		/* このアイテムを持っていたら出現する -1 は無視*/
	GROUP_NOTAPPEARBYITEMID,	/* このアイテムを持っていたら出現しない -1 は無視*/
    ENEMY_ID1,
    ENEMY_ID2,
    ENEMY_ID3,
    ENEMY_ID4,
